...
class Sheep {
    constructor(x, y, r, id) {
        ...
        this.lure = createVector(0,0)
        this.lured = false

        this.container = createVector(0,0)
        this.containerBound = 0
    ...
    is () {
        ...
        sense () {
            ...
            this.at()
                ...
                senseStampede(){
                    if (sheepPop[this.nearestSheep].spooked || sheepPop[this.nearestSheep].lured || sheepPop[this.nearestSheep].following) {
                    ...
                    for (let neighbor of this.neighbors) {
                        if (sheepPop[neighbor].spooked || sheepPop[neighbor].lured) {
                            stamp ++
                        }
                    }
                    if (stamp == 0 ) {
                ...
                senseFood() {
                    ...
                    for (let i = 0; i < field.length; i++) {
                            if (p5.Vector.dist(field[i].pos, this.container)<=this.containerBound){
